...
<head>
    <meta charset="UTF-8">
    <title>User FAQ | Fit2Go Admin Template</title>
    <link rel="shortcut icon" href="favicon.ico" />
    <meta content='width=devic.post-item .news-more-plus:hovere-width, initial-scale=1, maximum-scale=1, user-scalable=no' name='viewport'>
                                ...
                                <div class="panel-group" id="accordion5">
                                    <div class="panel">
                                        ...
                                        <div id="collapseOne" class="panel-collapse collapse in">
                                            <div class="panel-body">
                                                ...
                                                <p>
                                                    The Indian sage Patanjali is believed to have collated the practice of Yoga into the Yoga Sutra an estimated 2,000 years ago. The Sutra is a collection of 195 statements that serves as a philosophical guidebook for most of the Yoga that is practiced today. </p>
                                                <p>It also outlines eight limbs of yoga: the yamas (restraints), niyamas (observances), asana (postures), pranayama (breathing), pratyahara (withdrawal of senses), dharana (concentration), dhyani (meditation), and samadhi (absorption).
                                                </p>
                                                <p>
                                    ...
                                    <div class="panel">
                                        ...
                                        <div id="collapseTwo" class="panel-collapse collapse">
                                            <div class="panel-body">
                                                ...
                                                <p>
                                                    There is debate about this in the Yoga community—I believe that it is a personal decision that everyone has to make for themselves. If you are considering becoming a vegetarian, be sure to take into account your personal health issues as well how your choices will affect those with whom you live.</p>
                                    ...
                                    <div class="panel">
                                        ...
                                        <div id="collapseThree" class="panel-collapse collapse">
                                            <div class="panel-body">
                                                <p>
                                                    Yoga is amazing—even if you only practice for one hour a week, you will experience the benefits of the practice. If you can do more than that, you will certainly experience more benefits. </p>
                                                <p>I suggest starting with two or three times a week, for an hour or an hour and a half each time.
                                                </p>
                                                <p>
                                                    If you can only do 20 minutes per session, that’s fine too. Don’t let time constraints or unrealistic goals be an obstacle—do what you can and don’t worry about it.</p>
                                                <p>You will likely find that after awhile your desire to practice expands naturally and you will find yourself doing more and more.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="panel-group" id="accordion1">
                                    <div class="panel">
                                        ...
                                        <div id="collapseOne1" class="panel-collapse collapse in">
                                            <div class="panel-body">
                                                <p>
                                                    The ability to gain muscle while losing fat is dependent on the relationship between your fatness and muscularity. An overly-fat and under-trained person will be able to achieve simultaneous fat loss and muscle gain. </p>
                                    ...
                                    <div class="panel">
                                        ...
                                        <div id="collapseThree1" class="panel-collapse collapse">
                                            <div class="panel-body">
                                                <p>
                                                    The best thing you can do is to stop thinking that "motivation" is going to be what gets you results. Trying to sustain going to the gym or changing your diet with motivation is like trying to warm your house with a firecracker.</p>
                                ...
                                <div class="panel-group" id="accordion2">
                                    <div class="panel">
                                        ...
                                        <div id="collapseOne2" class="panel-collapse collapse in">
                                            <div class="panel-body">
                                                <p>
                                                    Step aerobics is a form of aerobic activity which is performed on a platform that usually ranges from 4" to 10" in height. </p>
                                                <p>Step training was developed to provide a low-impact activity that is both challenging and interesting. People who may not like certain aspects of aerobic dance find that step is a very good alternative.
                                                </p>
                                                <p>Each participant works within his or her own space. There is no traveling across a room. When done properly, step training is an efficient means of improving aerobic fitness.
                                                </p>
                                                <p>
                                    ...
                                    <div class="panel">
                                        ...
                                        <div id="collapseTwo2" class="panel-collapse collapse">
                                            <div class="panel-body">
                                                ...
                                                <p>
                                                    To avoid Achilles tendon injury, make sure your heel is down, and your foot is in the center of the platform. When stepping down, step close to the platform and allow the heels to contact the floor to help absorb the shock.
                                                </p>
                                                <p>(toe, ball, heel). When doing lunges or repeater steps, however, the heel should be up, and the weight should be on the forefoot of the working leg.
                                                </p>
                                                <p>You should not use hand or leg weights when you are stepping as the risk of injury outweighs any added benefit you might get from using weights.
                                                </p>
                                                <p>It is important to note, that anyone with a history of knee problems should consult a physician before beginning step training.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="panel">
                                        ...
                                        <div id="collapseThree2" class="panel-collapse collapse">
                                            <div class="panel-body">
                                                <p>
                                                    Step height depends on several things - fitness level, current stepping skill, and the degree of knee flexion when the knee is fully loaded while stepping up.
                                                </p>
                                                <p>At no time should the knee joint of the first leg to step up flex beyond a 90% angle. Reebok is now saying that 60% is even better. Deconditioned individuals or beginners should begin on a 4" platform.
                                                </p>
                                                <p>As you improve, you may add risers to increase the step height making sure not to exceed the 90 degrees of knee flexion. The most popular step heights are 6" and 8".
                                                </p>
                                                <p>
                                    ...
                                    <div class="panel">
                                        ...
                                        <div id="collapsefour2" class="panel-collapse collapse">
                                            <div class="panel-body">
                                                <p>
                                                    There are several ways to increase intensity. Increase your step height, use longer lever arms or add propulsion moves (where both feet are off the step at the same time).</p>
                                                <p>
                                                    If you are going to add propulsion, or power as it is known today, make sure not to do these moves for more than one minute at a time as these moves result in higher vertical impact. All power moves should be done as you go up onto the platform.
                                                </p>
                                                <p>Always step down without power. Power moves are considered advanced, and should not be attempted by beginners.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="panel-group" id="accordion3">
                                    <div class="panel">
                                        ...
                                        <div id="collapseOne4" class="panel-collapse collapse in">
                                            <div class="panel-body">
                                                <p>
                                                    First of all let's eliminate the name "meals". From experience, my client's interpretation of a meal is more like a feast. My advice to them from the start is to increase the number of meals to five everyday, then they look at me feeling sick at the thought of eating so much so often.
                                                </p>
                                                <p>What they don't realize is that healthy fat loss foods aren't as calorie dense and not as filling as other meals. Quantity is also decreased, so from here on we'll call meals "snacks" or "grazing intervals"
                                                </p>
                                                <p>
