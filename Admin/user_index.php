...
<head>
    <meta charset="UTF-8">
    <title>Welcome to Fit2Go User Dashboard</title>
    ...
    <link type="text/css" href="assets/css/custom_css/index.css" rel="stylesheet">
    <link type="text/css" href="vendors/progressbar/assets/css/bootstrap-progressbar.min.css" rel="stylesheet" />
    <link type="text/css" href="assets/css/custom_css/user_dashboard.css" rel="stylesheet" />
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-3 col-xs-12">
                        <div class="user_box">
                            <div class="fit-user">
                                <img src="assets/img/authors/avatar1.jpg" class="img-responsive" alt="image not found">
                            </div>
                                    ...
                                    <div class="newstick">
                                        <div class="news-items">
                                            ...
                                            <div>
                                                <a href='user_eventitem.php'>
                                                    <div class="row">
                                                        <img src="assets/img/admin/event3.png" class="recent-user-img" alt="image mot found">
