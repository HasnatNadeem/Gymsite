<header class="header" style="background-color: black">
        <nav class="navbar navbar-static-top" style="background-color: black">
            <a class='logo' href='admin_login.php' style="background-color: black">
                <!-- Add the class icon to your logo image or logo icon to add the margining -->
                <img src="assets/img/logomy.png" alt="image not found">
            </a>
                ...
                <ul class="nav navbar-nav">
                        ...
                        <ul class="dropdown-menu dropdown-messages table-striped">
                            ...
                            <li>
                                <a href="#" class="message">
                                    <img class="message-image img-circle" alt="image" src="img/authors/my.jpg">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle padding-user" data-toggle="dropdown">
                            <img src="img/authors/my.jpg" width="35" class="img-circle img-responsive pull-left" height="35" alt="User Image">
                            <div class="riot">
                                <div>
                                    Hasnat
                                    <span>
