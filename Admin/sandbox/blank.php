...
<!-- Mirrored from demo.lorvent.com/fitness/blank by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 21 Apr 2024 12:19:49 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="UTF-8">
    <title>Blank | Fit2Go Admin Template</title>
                    ...
                    <ul class="navigation">
                        ...
                        <li>
                            <a href='profile_view.php'>
                                <i class="text-warning menu-icon fa fa-users fa-info-circle"></i>
                                <span class="mm-text">Profile View</span>
                            </a>
                        </li>
                            ...
                            <ul class="sub-menu">
                                ...
                                <li>
                                    <a href='admin_trainers.php'>
                                        <i class="text-danger menu-icon  fa fa-fw fa-paw"></i> Trainers
                                    </a>
                                </li>
                            </ul>
                        </li>
...
<!-- Mirrored from demo.lorvent.com/fitness/blank by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 21 Apr 2024 12:19:50 GMT -->
</html>
