...
<!-- Mirrored from demo.lorvent.com/fitness/user_eventslist by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 21 Apr 2024 12:21:29 GMT -->
        ...
        <aside class="right-side right-padding">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href='user_eventslist.php'>Events List</a>
                    </li>
                </ol>
            </section>
            <!--section ends-->
                                        ...
                                        <div class="col-sm-6">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8 col-lg-10">
                                                    <h4>
                                                    <a href='user_eventitem.php'>One Week Yoga Special Training by -
                                                        John C</a>
                                                </h4>
                                                    <p class="paragraph_text_color">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                                                    <p class="paragraph_text_color"> Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
                                                    <ul class="sub-menu">
