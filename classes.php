...
<head>
	<meta charset="utf-8">
	<title>Gym HTML-5 Template | Classes</title>
	<!-- Stylesheets -->
			...
			<div class="auto-container">
				<div class="row clearfix">
					...
					<div class="classess-block col-lg-4 col-md-6 col-sm-12">
						<div class="inner-box">
							<div class="image">
								<a href="classes-detail.php"><img src="assets/images/resource/53.jpg" alt="" /></a>
								<div class="icon-box">
					...
					<div class="classess-block col-lg-4 col-md-6 col-sm-12">
						<div class="inner-box">
							<div class="image">
								<a href="classes-detail.php"><img src="assets/images/resource/feature-4.jpg" alt="" /></a>
								<div class="icon-box">
							...
							<div class="lower-content">
								...
								<h4><a href="classes-detail.php">Strength Training</a></h4>
								<div class="text">Winning means you’re willing to go longer, work harder for more.</div>
								<a class="read-more" href="classes-detail.php">Read More</a>
							</div>
						</div>
					...
					<div class="classess-block col-lg-4 col-md-6 col-sm-12">
						<div class="inner-box">
							<div class="image">
								<a href="classes-detail.php"><img src="assets/images/resource/feature-5.jpg" alt="" /></a>
								<div class="icon-box">
							...
							<div class="lower-content">
								<div class="title">CARDIO</div>
								<h4><a href="classes-detail.php">Cardio For Man</a></h4>
								<div class="text">Don’t practice until you get it right practice until can’t wrong</div>
								<a class="read-more" href="classes-detail.php">Read More</a>
							</div>
						</div>
					...
					<div class="classess-block col-lg-4 col-md-6 col-sm-12">
						<div class="inner-box">
							<div class="image">
								<a href="classes-detail.php"><img src="assets/images/resource/feature-6.jpg" alt="" /></a>
								<div class="icon-box">
							...
							<div class="lower-content">
								...
								<h4><a href="classes-detail.php">Advance GYM</a></h4>
								<div class="text">Winning means you’re willing to go longer, work harder for more.</div>
								<a class="read-more" href="classes-detail.php">Read More</a>
							</div>
						</div>
...
<!-- Mirrored from expert-themes.com/html/gym/classes.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 09 Mar 2024 11:26:36 GMT -->
