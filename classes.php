		...
		<div class="auto-container">
			<div class="row clearfix">
				...
				<div class="classess-block col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box">
						<div class="image">
							<a href="classes-detail.php"><img src="images/resource/feature-4.jpg" alt="" /></a>
							<div class="icon-box">
				...
				<div class="classess-block col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box">
						<div class="image">
							<a href="classes-detail.php"><img src="images/resource/feature-5.jpg" alt="" /></a>
							<div class="icon-box">
				...
				<div class="classess-block col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box">
						<div class="image">
							<a href="classes-detail.php"><img src="images/resource/feature-6.jpg" alt="" /></a>
							<div class="icon-box">
