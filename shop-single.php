...
<head>
<meta charset="utf-8">
<title>Gym HTML-5 Template | Shop Single</title>
<!-- Stylesheets -->
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="info-column col-lg-6 col-md-12 col-sm-12">
                            <div class="details-header">
                                ...
                                <div class="item-price">Price: $99.00</div>
                            </div>
                            ...
                            <div class="other-options">
                                <div class="clearfix">
                                    ...
                                    <div class="pull-left">
                                        <!--Btns Box-->
                                        <div class="btns-box">
                                            <button type="button" class="theme-btn btn-style-three"><span class="txt">Add To Cart</span></button>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="tab" id="prod-reviews">
                                ...
                                <div class="reviews-container">
                                    ...
                                    <div class="add-review">
                                        ...
                                        <form method="post" action="https://expert-themes.com/html/gym/shop-single.php">
                                            <div class="row clearfix">
