...
<head>
	<meta charset="utf-8">
	<title>Gym HTML-5 Template | Testimonial</title>
	<!-- Stylesheets -->
			...
			<div class="auto-container">
				...
				<div class="row clearfix">
					...
					<div class="testimonial-block-three col-lg-4 col-md-6 col-sm-12">
						<div class="inner-box">
							<div class="text">Omnis voluptas assumenda est, omnis dolor repellendus. Temporibus autem quibusdam et aut officiis debitis aut rerum necessitatibus.</div>
							<div class="rating">
							...
							<h4>James</h4>
							<div class="designation">Manager Director</div>
							<div class="author-image">
								<div class="image">
									<img src="assets/images/resource/new35.jpg" alt="" />
								</div>
					...
					<div class="testimonial-block-three col-lg-4 col-md-6 col-sm-12">
						<div class="inner-box">
							...
							<div class="author-image">
								<div class="image">
									<img src="assets/images/resource/new37.jpg" alt="" />
								</div>
								<span class="quote-icon flaticon-quote"></span>
							</div>
						</div>
