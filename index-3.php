...
<body class="hidden-bar-wrapper">
	...
	<div class="page-wrapper">
		...
		<section class="calculate-section-two">
			<div class="auto-container">
				<div class="inner-container">
					<div class="pattern-layer" style="background-image:url(assets/images/background/3.jpg)"></div>
				...
				<div class="row clearfix">
					...
					<div class="featured-block-two col-lg-4 col-md-6 col-sm-12">
						<div class="inner-box wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
							<div class="image">
								<a href="classes-detail.php"><img src="assets/images/resource/feature-1.jpg" alt="" /></a>
								<div class="icon-box">
					...
					<div class="featured-block-two col-lg-4 col-md-6 col-sm-12">
						<div class="inner-box wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
							<div class="image">
								<a href="classes-detail.php"><img src="assets/images/resource/feature-2.jpg" alt="" /></a>
								<div class="icon-box">
					...
					<div class="featured-block-two col-lg-4 col-md-6 col-sm-12">
						<div class="inner-box wow fadeInRight" data-wow-delay="0ms" data-wow-duration="1500ms">
							<div class="image">
								<a href="classes-detail.php"><img src="assets/images/resource/feature-3.jpg" alt="" /></a>
								<div class="icon-box">
									<span class="icon flaticon-people"></span>
								</div>
							</div>
		...
		<section class="testimonial-section">
			<div class="auto-container">
				<div class="inner-container" style="background-image:url(assets/images/background/5.jpg)">
					<div class="row clearfix">
			...
			<div class="auto-container">
				...
				<div class="row clearfix">
					...
					<div class="news-block-two col-lg-4 col-md-6 col-sm-12">
						<div class="inner-box wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
							<div class="image">
								<a href="blog-single.php"><img src="assets/images/resource/news-4.jpg" alt="" /></a>
							</div>
							<div class="lower-content">
								<ul class="post-meta">
					...
					<div class="news-block-two col-lg-4 col-md-6 col-sm-12">
						<div class="inner-box wow fadeInLeft" data-wow-delay="150ms" data-wow-duration="1500ms">
							<div class="image">
								<a href="blog-single.php"><img src="assets/images/resource/news-5.jpg" alt="" /></a>
							</div>
							<div class="lower-content">
								<ul class="post-meta">
					...
					<div class="news-block-two col-lg-4 col-md-6 col-sm-12">
						<div class="inner-box wow fadeInLeft" data-wow-delay="300ms" data-wow-duration="1500ms">
							<div class="image">
								<a href="blog-single.php"><img src="assets/images/resource/news-6.jpg" alt="" /></a>
							</div>
							<div class="lower-content">
								<ul class="post-meta">
