...
<head>
	...
	<meta charset="utf-8">
	<title>Gym HTML-5 Template | Team</title>
	<!-- Stylesheets -->
				...
				<div class="row clearfix">
					...
					<div class="team-block col-lg-4 col-md-4 col-sm-12">
						<div class="inner-box wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
							<div class="image">
								<a href="#"><img src="assets/images/resource/new4.jpg" alt="" /></a>
							</div>
							<div class="content">
								<div class="title">Crossfit Coach</div>
								<a href="team.php" class="name">HASSAN JUNIOR</a>
							</div>
					...
					<div class="team-block col-lg-4 col-md-4 col-sm-12">
						<div class="inner-box wow fadeInRight" data-wow-delay="0ms" data-wow-duration="1500ms">
							<div class="image">
								<a href="#"><img src="assets/images/resource/new6.jpg" alt="" /></a>
							</div>
							<div class="content">
								<div class="title">Cardio & Conditioning</div>
								<a href="team.php" class="name">Jimmy FRON</a>
							</div>
							<div class="shared-boxed">
								<div class="shared-inner">
									<span class="share-now fa fa-share-alt"></span>
					...
					<div class="team-block col-lg-4 col-md-4 col-sm-12">
						<div class="inner-box wow fadeInRight" data-wow-delay="0ms" data-wow-duration="1500ms">
							<div class="image">
								<a href="#"><img src="assets/images/resource/new35.jpg" alt="" /></a>
							</div>
							<div class="content">
								<div class="title">Crossfit Coach</div>
								<a href="team.php" class="name">James</a>
							</div>
							<div class="shared-boxed">
								<div class="shared-inner">
									<span class="share-now fa fa-share-alt"></span>
					...
					<div class="team-block col-lg-4 col-md-4 col-sm-12">
						<div class="inner-box wow fadeInRight" data-wow-delay="0ms" data-wow-duration="1500ms">
							<div class="image">
								<a href="#"><img src="assets/images/resource/team-5.jpg" alt="" /></a>
							</div>
							<div class="content">
								<div class="title">Bodybuilding Coach</div>
								<a href="team.php" class="name">SMITH Cross</a>
							</div>
							<div class="shared-boxed">
								<div class="shared-inner">
									<span class="share-now fa fa-share-alt"></span>
					...
					<div class="team-block col-lg-4 col-md-4 col-sm-12">
						<div class="inner-box wow fadeInRight" data-wow-delay="0ms" data-wow-duration="1500ms">
							<div class="image">
								<a href="#"><img src="assets/images/resource/new37.jpg" alt="" /></a>
							</div>
							<div class="content">
								<div class="title">Cardio & Conditioning</div>
								<a href="team.php" class="name">Wills Smith</a>
							</div>
							<div class="shared-boxed">
								<div class="shared-inner">
									<span class="share-now fa fa-share-alt"></span>
