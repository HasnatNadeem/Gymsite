...
<head>
<meta charset="utf-8">
<title>Gym HTML-5 Template | Portfolio</title>
<!-- Stylesheets -->
...
<div class="page-wrapper">
    ...
    <div class="preloader"></div>
 	...
 	<!-- Main Header-->
	 <?php include ('components/header.php') ?>    <!-- End Main Header -->
						...
						<div class="image">
							...
							<div class="content">
								<div class="content-inner">
									<h6><a href="portfolio-detail.php">Cardio Program</a></h6>
									<a href="portfolio-detail.php" class="icon fa fa-arrow-circle-o-right"></a>
								</div>
							</div>
						</div>
					</div>
