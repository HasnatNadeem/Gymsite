...
<head>
<meta charset="utf-8">
<title>Gym HTML-5 Template | Classes Detail</title>
<!-- Stylesheets -->
        	...
        	<div class="row clearfix">
                	...
                	<aside class="sidebar padding-right">
                        ...
                        <div class="sidebar-widget">
                            <ul class="service-list">
                                <li class="current"><a href="classes-detail.php">All Classess</a></li>
                                <li><a href="classes-detail.php">Psycho Training</a></li>
                                <li><a href="classes-detail.php">Self Defence</a></li>
                                <li><a href="classes-detail.php">Fitness For Man</a></li>
                                <li><a href="classes-detail.php">Strength Training</a></li>
                                <li><a href="classes-detail.php">Cardio For Man</a></li>
								<li><a href="classes-detail.php">Advance GYM</a></li>
                            </ul>
                        </div>
						...
						<div class="sidebar-widget help-widget">
							<div class="widget-content">
								<div class="inner-box">
									<div class="image">
										<img src="images/resource/classes.jpg" alt="" />
									</div>
                ...
                <div class="content-side col-lg-8 col-md-12 col-sm-12">
                	<div class="classes-detail">
						<div class="inner-box">
							<div class="image">
								<img src="images/resource/classes-detail.jpg" alt="" />
							</div>
							<div class="lower-content">
...
<!-- Mirrored from expert-themes.com/html/gym/classes-detail.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 09 Mar 2024 11:26:37 GMT -->
</html>