			...
			<div class="row clearfix">
				...
				<div class="service-block col-lg-4 col-md-6 col-sm-12">
					...
					<div class="inner-box">
						...
						<h4><a href="classes-detail.php">Progression</a></h4>
				...
				<div class="service-block style-two col-lg-4 col-md-6 col-sm-12">
					...
					<div class="inner-box">
						...
						<h4><a href="classes-detail.php">Workout</a></h4>
				...
				<div class="service-block style-three col-lg-4 col-md-6 col-sm-12">
					...
					<div class="inner-box">
						...
						<h4><a href="classes-detail.php">Nutrition</a></h4>
				...
				<div class="team-block col-lg-4 col-md-6 col-sm-12">
					...
					<div class="inner-box wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
						...
						<div class="content">
							...
							<a href="team.php" class="name">MATIE JUNIOR</a>
				...
				<div class="team-block col-lg-4 col-md-6 col-sm-12">
					...
					<div class="inner-box wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
						...
						<div class="content">
							...
							<a href="team.php" class="name">Steve Cross</a>
				...
				<div class="team-block col-lg-4 col-md-6 col-sm-12">
					...
					<div class="inner-box wow fadeInRight" data-wow-delay="0ms" data-wow-duration="1500ms">
						...
						<div class="content">
							...
							<a href="team.php" class="name">MAdona FRON</a>
				...
				<div class="news-block col-lg-4 col-md-6 col-sm-12">
					...
					<div class="inner-box wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
						...
						<div class="lower-content">
							...
							<h4><a href="blog-single.php">Push Your Fitness Further With Facilities</a></h4>

							<div class="text">at vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis accusamus et </div>

							<div class="btn-three-outer"><a href="blog-single.php" class="theme-btn btn-style-three"><span class="txt">Read More</span></a></div>
				...
				<div class="news-block col-lg-4 col-md-6 col-sm-12">
					...
					<div class="inner-box wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
						...
						<div class="lower-content">
							...
							<h4><a href="blog-single.php">How to keep your Body HEALTHY IN OVER FESTIVAL</a></h4>
...
<!-- Mirrored from expert-themes.com/html/gym/index.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 09 Mar 2024 11:26:22 GMT -->
</html>